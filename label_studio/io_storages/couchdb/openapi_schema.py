...
_common_couchdb_storage_schema_properties = {
...
_couchdb_import_storage_schema = openapi.Schema(
...
_couchdb_import_storage_schema_with_id = openapi.Schema(
    type=openapi.TYPE_OBJECT,
    properties=dict(
        id=openapi.Schema(
            type=openapi.TYPE_INTEGER, description='Storage ID. If set, storage with specified ID will be updated'
        ),
        **_couchdb_import_storage_schema.properties,
    ),
    required=[],
)


_couchdb_export_storage_schema = openapi.Schema(
    type=openapi.TYPE_OBJECT,
    properties=dict(
...
_couchdb_export_storage_schema_with_id = openapi.Schema(
    type=openapi.TYPE_OBJECT,
    properties=dict(
        id=openapi.Schema(
            type=openapi.TYPE_INTEGER, description='Storage ID. If set, storage with specified ID will be updated'
        ),
        **_couchdb_export_storage_schema.properties,
    ),
    required=[],
)
