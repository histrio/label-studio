...
from .couchdb.api import CouchDBImportStorageListAPI, CouchDBExportStorageListAPI
...
def get_storage_list():
    return [
        ...
        },
        {
            'name': 'couchdb',
            'title': 'CouchDB',
            'import_list_api': CouchDBImportStorageListAPI,
            'export_list_api': CouchDBExportStorageListAPI,
        },
    ]
